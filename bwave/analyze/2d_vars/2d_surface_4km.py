...
### Save the output
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/slp_surface_4km',slp1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/dbz_surface_4km',dbz1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/tsfc_surface_4km',tsfc1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/z250_surface_4km',z2501)
