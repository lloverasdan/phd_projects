...
nc2 = Dataset('/p/work1/lloveras/bwave_nov/20km_files/standard/output/wrfout_dry')
...
### Save the output
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/slp_standard_moist_20km',slp1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/dbz_standard_20km',dbz1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/tsfc_standard_moist_20km',tsfc1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/z250_standard_moist_20km',z2501)

np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/slp_standard_dry_20km',slp2)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/tsfc_standard_dry_20km',tsfc2)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/z250_standard_dry_20km',z2502)
