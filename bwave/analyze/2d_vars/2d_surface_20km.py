...
nc1 = Dataset('/p/work1/lloveras/bwave_nov/20km_files/surface/output/wrfout_moist')
nc2 = Dataset('/p/work1/lloveras/bwave_nov/20km_files/surface/output/wrfout_dry')
...
### Save the output
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/slp_surface_moist_20km',slp1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/dbz_surface_20km',dbz1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/tsfc_surface_moist_20km',tsfc1)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/z250_surface_moist_20km',z2501)

np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/slp_surface_dry_20km',slp2)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/tsfc_surface_dry_20km',tsfc2)
np.save('/p/work1/lloveras/bwave_nov/processed/2d_vars/z250_surface_dry_20km',z2502)
