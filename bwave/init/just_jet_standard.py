...
### Save files
np.save('/p/work1/lloveras/bwave/processed/jets/u_standard_rh75',u_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/th_standard_rh75',theta_new)
np.save('/p/work1/lloveras/bwave/processed/jets/thv_standard_rh75',theta_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/rh_standard_rh75',rh_it)
np.save('/p/work1/lloveras/bwave/processed/jets/qv_standard_rh75',qv)
np.save('/p/work1/lloveras/bwave/processed/jets/pv_standard_rh75',pv_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/z_standard_rh75',ph_eta/G)
np.save('/p/work1/lloveras/bwave/processed/jets/p_standard_rh75',p_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/cape_standard_rh75',cape1d)
