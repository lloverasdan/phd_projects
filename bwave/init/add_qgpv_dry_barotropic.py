...
### Read in the file
nc_in = Dataset('/p/work1/lloveras/bwave_nov/20km_files/barotropic/input/wrfin_dry','r+')
...
if moist:
    ...
    t_moist = theta_new[-1,:,:,:] - T0
    tsk_moist = theta_new[-1,0,:,:]*(((p + pb)[0,:,:]/P0)**(RD/CP))
