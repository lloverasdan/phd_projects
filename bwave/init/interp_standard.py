...
nc_in = nc.Dataset('/p/work1/lloveras/bwave/20km_files/standard/input/wrfin_moist_rh65')
...
# WRITE
nc_out = nc.Dataset('/p/work1/lloveras/bwave/4km_files/input/wrfin_standard_rh65','w',format=netcdf_type)
