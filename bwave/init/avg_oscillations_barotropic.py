...
ny = 360
nx = 400
nc_out = Dataset('/p/work1/lloveras/bwave_nov/20km_files/barotropic/setup/wrfout_osc')
...
nc_in = Dataset('/p/work1/lloveras/bwave_nov/20km_files/barotropic/setup/wrfin_avg','r+')
