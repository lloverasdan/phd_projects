...
nc_in = nc.Dataset('/p/work1/lloveras/bwave/20km_files/barotropic/input/wrfin_moist_rh65')
...
# WRITE
nc_out = nc.Dataset('/p/work1/lloveras/bwave/4km_files/input/wrfin_barotropic_rh65','w',format=netcdf_type)
