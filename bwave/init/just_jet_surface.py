...
### Save files
np.save('/p/work1/lloveras/bwave/processed/jets/ubot_surface_rh75',u_h[0])
np.save('/p/work1/lloveras/bwave/processed/jets/phbot_surface_rh75',f_h[0])
np.save('/p/work1/lloveras/bwave/processed/jets/u_surface_rh75',u_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/th_surface_rh75',theta_new)
np.save('/p/work1/lloveras/bwave/processed/jets/thv_surface_rh75',theta_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/rh_surface_rh75',rh_it)
np.save('/p/work1/lloveras/bwave/processed/jets/qv_surface_rh75',qv)
np.save('/p/work1/lloveras/bwave/processed/jets/pv_surface_rh75',pv_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/z_surface_rh75',ph_eta/G)
np.save('/p/work1/lloveras/bwave/processed/jets/p_surface_rh75',p_eta)
np.save('/p/work1/lloveras/bwave/processed/jets/cape_surface_rh75',cape1d)
