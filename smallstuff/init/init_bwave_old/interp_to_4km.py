...
nc_in = nc.Dataset('/p/work/lloveras/bwave/20km_files/in_files/wrfin_nocape')
...
# WRITE
nc_out = nc.Dataset('/p/work/lloveras/bwave/4km_files/in_files/wrfin_nocape','w',format=netcdf_type)
