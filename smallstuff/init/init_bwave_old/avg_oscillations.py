...
ny = 225
nx = 250
nc_out = Dataset('/p/work/lloveras/bwave/32km_files/noshear_high/setup/wrfout_osc')
...
nc_in = Dataset('/p/work/lloveras/bwave/32km_files/noshear_high/setup/wrfin_avg','r+')
