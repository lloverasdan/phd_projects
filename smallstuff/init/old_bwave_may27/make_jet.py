...
### WRF file strings
file_name = '/p/work1/lloveras/bwave/20km_files/noshear/setup/wrfin_start'
...
p_bot = 101200. # bottom pressure in Pa
...
phbot = 0. # mean phi at bottom in m^2/s^2 (corresponds to pressure level p_bot)
dph = 750. # max displacement from mean bottom phi in m^2/s^2
...
pv_l, f_l, u_l, theta_l, pv_out_l = epv_jet.solve_PV_inversion(ly, ny_l, \
    dy_l, dytr, pim, dpitr, pvt, pvs, dpipv, npi_l, p_bot, pibot, pitop, dpi_l, \
...
pv_h, f_h, u_h, theta_h, pv_out_h = epv_jet.solve_PV_inversion(ly, ny_h, \
    dy_h, dytr, pim, dpitr, pvt, pvs, dpipv, npi_h, p_bot, pibot, pitop, dpi_h, \
