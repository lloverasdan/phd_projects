...
nc_in = nc.Dataset('/p/work1/lloveras/bwave/20km_files/noshear/input/wrfin_moist')
...
# WRITE
nc_out = nc.Dataset('/p/work1/lloveras/bwave/4km_files/wrfin_noshear','w',format=netcdf_type)
