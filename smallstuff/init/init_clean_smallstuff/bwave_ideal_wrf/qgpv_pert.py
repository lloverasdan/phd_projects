...
#%% Gaussian QGPV anomaly
    
def qgpv_anom_gauss(qgpv_mag, x_pert, y_pert, z_pert, az, ax, ay, x, y, z, \
...
def qgpv_anom_cos(qgpv_mag, x_pert, y_pert, z_pert, az, ax, ay, x, y, z, \
              xg, yg, nx, ny, nz, n_pert, facz, dz, dtdz_pert):
...
def qgpv_theta(qgpv_mag, x_pert, y_pert, th_pert, ath, ax, ay, x, y, z, \
...
def qgpv_surf(theta_mag, x_pert, y_pert, ax, ay, x, y, z, \
              xg, yg, nx, ny, nz, n_pert, facz, dz, dtdz_pert):
