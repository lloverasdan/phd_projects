...
new_dir = '/p/work1/lloveras/adj_4km/rst_input/adj_48h_neg/wrfrst_d01_2021-01-03_00_00_00'
...
ncfile.variables['U_1'][0,:,:,:] = u_ctl - u_pert
ncfile.variables['V_1'][0,:,:,:] = v_ctl - v_pert
ncfile.variables['T_1'][0,:,:,:] = t_ctl - t_pert
ncfile.variables['P'][0,:,:,:] = p_ctl - p_pert
ncfile.variables['QVAPOR'][0,:,:,:] = qv_ctl - qv_pert
ncfile.variables['U_2'][0,:,:,:] = u_ctl - u_pert
ncfile.variables['V_2'][0,:,:,:] = v_ctl - v_pert
ncfile.variables['T_2'][0,:,:,:] = t_ctl - t_pert
