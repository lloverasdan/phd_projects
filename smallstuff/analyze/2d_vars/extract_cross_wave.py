...
nc1 = Dataset('/p/work1/lloveras/adj_4km/short_runs/wave_48h/wrfout_d01_2021-01-03_00_00_00')
...
### Save the output
np.save('/p/work1/lloveras/adj_4km/proc_short/dbz_wave',dbz1)
np.save('/p/work1/lloveras/adj_4km/proc_short/th_wave',t1)
np.save('/p/work1/lloveras/adj_4km/proc_short/z_wave',z1)