...
nc1 = Dataset('/p/work1/lloveras/adj_4km/short_runs/wave_48h_100/wrfout_d01_2021-01-03_00_00_00')
...
### Save the output
np.save('/p/work1/lloveras/adj_4km/proc_short/dbz_wave100',dbz1)
np.save('/p/work1/lloveras/adj_4km/proc_short/th_wave100',t1)
np.save('/p/work1/lloveras/adj_4km/proc_short/z_wave100',z1)