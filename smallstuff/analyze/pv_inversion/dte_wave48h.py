...
### File paths
file_path_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/dte_up'
file_path_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/dte_low'

### Load the numpy files
u_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/u_up.npy')
v_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/v_up.npy')
th_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/th_up.npy')

u_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/u_low.npy')
v_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/v_low.npy')
th_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_48h/th_low.npy')
