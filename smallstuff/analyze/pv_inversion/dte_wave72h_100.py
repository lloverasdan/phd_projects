...
### File paths
file_path_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/dte_up'
file_path_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/dte_low'

### Load the numpy files
u_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/u_up.npy')
v_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/v_up.npy')
th_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/th_up.npy')

u_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/u_low.npy')
v_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/v_low.npy')
th_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h_100/th_low.npy')
