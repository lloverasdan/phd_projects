...
### File paths
file_path_u_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/u_up'
file_path_v_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/v_up'
file_path_th_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/th_up'

file_path_u_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/u_low'
file_path_v_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/v_low'
file_path_th_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/th_low'

### Load the numpy files
dqgpv_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/dqgpv_up.npy')
dqgpv_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/dqgpv_low.npy')
dts = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/wave_72h/dts.npy')
