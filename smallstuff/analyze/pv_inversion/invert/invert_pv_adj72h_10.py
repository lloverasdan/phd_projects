...
### File paths
file_path_u_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/u_up'
file_path_v_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/v_up'
file_path_th_up = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/th_up'

file_path_u_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/u_low'
file_path_v_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/v_low'
file_path_th_low = '/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/th_low'

### Load the numpy files
dqgpv_up = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/dqgpv_up.npy')
dqgpv_low = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/dqgpv_low.npy')
dts = np.load('/p/work1/lloveras/adj_4km/processed/pv_inversion/adj_72h_10/dts.npy')
